# HTTP-services Personal аccount (1.1.6.8)
...
В версии 1.1.6.8 обновлено описание сервиса [Product](#product).
...
https://server.ru/PersAcc/files/ScansSale?guid=4216db9a-fee9-11ed-81c2-00155df43005,d63ca337-003b-11ee-81c2-00155df43005,aa4ab8d3-e5bc-11ed-81bd-00155df43005
```
...
**Ответ в формате _JSON_**: \* Двоичные данные (если передано несколько guid-ов, то возвращаются двоичные данные архива .zip) или
...
| \* ValueType    |   Строка    |      Да      | Тип значения (discount - скидка, price - цена, только для DiscountType = Номенклатура) |
...
| [Others](#properties-others-product) (\*) |           Массив            |      Да      | Массив свойств номенклатуры                       |

#### **Properties Others (Product):**

| Параметры |             Тип             | Обязательный | Описание                                                                                                                         |
| --------- | :-------------------------: | :----------: | :------------------------------------------------------------------------------------------------------------------------------- |
| GUID      |         Строка (36)         |      Да      | Идентификатор свойства                                                                                                           |
| Name      |           Строка            |      Да      | Наименование свойства                                                                                                            |
| TypeValue |            Число            |      Да      | Тип значения свойства. 0 - Строка, 1 - Число, 2 - Булево, 3 - Дата, 4 - Ссылочный тип в 1С, в ключе Value будет приходить строка |
| Value     | Строка, Число, Булево, Дата |      Да      | Значение свойства                                                                                                                |
