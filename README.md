...
| [Data][push-data] | Массив |      Да      | Данные для обработки                                                                                                                                                                                                                                   |
...
| TransactionID | Строка (36) |     Нет      | [См. общее](#общее) |
| SourceID      | Строка (36) |      Да      | [См. общее](#общее) |
| Documents     |   Объект    |      Да      | Данные документов   |

**Documents:**

| Параметры |  Тип   | Обязательный | Описание                          |
| --------- | :----: | :----------: | :-------------------------------- |
| Sales     | Массив |      Да      | Массив данных расходных накладных |
...
| Параметры |  Тип   | Обязательный | Описание                          |
| --------- | :----: | :----------: | :-------------------------------- |
| Orders    | Массив |      Да      | Массив данных заказов покупателей |
...
| Параметры      |  Тип   | Обязательный | Описание                    |
| -------------- | :----: | :----------: | :-------------------------- |
| PurchaseOrders | Массив |      Да      | Массив данных заказ-нарядов |
...
| TransactionID | Строка (36) |     Нет      | [См. общее](#общее)    |
| SourceID      | Строка (36) |      Да      | [См. общее](#общее)    |
| ProductItems  |   Массив    |      Да      | Данные по номенклатуре |
...
| SourceID      | Строка (36) |      Да      | [См. общее](#общее)    |
| ProductItems  |   Массив    |      Да      | Данные по номенклатуре |
| WorkItems     |   Массив    |      Да      | Данные по работам      |
...
| Order               |   Объект    |      Да      | Информация по заказу               |
...
| SizeVAT     |            Число            |      Да      | Ставка НДС                                   |
| Products    |           Массив            |      Да      | Данные по номенклатуре                       |
